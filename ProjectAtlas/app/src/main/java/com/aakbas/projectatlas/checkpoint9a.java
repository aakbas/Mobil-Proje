...
public class checkpoint9a extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_checkpoint9a);
    ...
    public void Checkpoint11(View view){
        Intent intent=new Intent(checkpoint9a.this,checkpoint11.class);
